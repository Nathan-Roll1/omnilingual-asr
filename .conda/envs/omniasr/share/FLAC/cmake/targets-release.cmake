...
set_target_properties(FLAC::FLAC PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libFLAC.8.3.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libFLAC.8.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS FLAC::FLAC )
list(APPEND _IMPORT_CHECK_FILES_FOR_FLAC::FLAC "${_IMPORT_PREFIX}/lib/libFLAC.8.3.0.dylib" )

# Import target "FLAC::FLAC++" for configuration "Release"
set_property(TARGET FLAC::FLAC++ APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(FLAC::FLAC++ PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libFLAC++.6.3.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libFLAC++.6.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS FLAC::FLAC++ )
list(APPEND _IMPORT_CHECK_FILES_FOR_FLAC::FLAC++ "${_IMPORT_PREFIX}/lib/libFLAC++.6.3.0.dylib" )
